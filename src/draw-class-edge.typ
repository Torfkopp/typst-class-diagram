...
#import "fletcher/src/coords.typ": default-ctx, find-farthest-intersection, uv-to-xy
#import "fletcher/src/edge.typ": find-nodes-for-edge, parametrised-edge
